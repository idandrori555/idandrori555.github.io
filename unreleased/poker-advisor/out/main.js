...
var buttonText = "\u05E9\u05D0\u05DC \u05D0\u05EA \u05D4\u05E7\u05D5\u05E0\u05DB\u05D9\u05D9\u05D4!";
var currentAnswer = "";
var sounds = answers.map((a) => new Audio(a.soundSrc));
function animateValue(startValue, endValue, duration, easingFn, onUpdate, onComplete) {
  let startTime = null;
...
function updateButtonState() {
  ...
  askButtonGradient.classList.toggle("ask-button-gradient-enabled", !isButtonDisabled);
  askButtonGradient.classList.toggle("ask-button-gradient-disabled", isButtonDisabled);
}
var handleAsk = () => {
  currentAnswer = "";
  ...
  buttonText = "\u05D4\u05E7\u05D5\u05E0\u05DB\u05D9\u05D9\u05D4 \u05D7\u05D5\u05E9\u05D1\u05EA... \u{1F914}";
  updateButtonState();
